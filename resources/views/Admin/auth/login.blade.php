...
<html lang="{{session()->get('locale')}}" dir="{{session()->get('locale')=='ar'?'rtl':'ltr'}}">
	...
	<head>
		...
		<!-- TITLE -->
		<title>{{setting()->app_name}} –  {{__('login')}}</title>
	...
	<body class="app sidebar-mini" style="direction: {{session()->get('locale')=='ar'?'rtl':'ltr'}}">

		<!-- BACKGROUND-IMAGE -->
		<div class="login-img">

			<!-- GLOABAL LOADER -->
			<div id="global-loader" style="background-color: transparent">
						...
						<div class="wrap-login100 p-6">
                            <form id="login_form" class="login100-form validate-form" action="{{route('post_login')}}" enctype="application/x-www-form-urlencoded" method="post">
								...
								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
									<input class="input100" type="text" placeholder="{{__('E-mail')}}" name="email">
								...
								<div class="wrap-input100 validate-input" data-validate = "Password is required">
									<input class="input100 password" type="password" placeholder="{{__('Password')}}" name="password" >
									<span class="focus-input100"></span>
									<span class="symbol-input100">
