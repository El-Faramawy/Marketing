...
@section('page_title') Region @endsection
@section('content')
    <div class="row">
                    ...
                    <div class="btn btn-sm btn-icon btn-active-color-primary" style="cursor: pointer" data-dismiss="modal" aria-label="Close">
                        ...
                        <span class="svg-icon svg-icon-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <rect opaRegion="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)"
                                      fill="black"/>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'regions'])
